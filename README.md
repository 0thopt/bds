...
- [Tests](https://github.com/0thopt/bds/actions) at [0thopt/bds](https://github.com/0thopt/bds)
    ...
    - [![Profile original cbds and lam terminating outer loop, big](https://github.com/0thopt/bds/actions/workflows/profile_orig_cbds_lam_terminating_outer_big.yml/badge.svg)](https://github.com/0thopt/bds/actions/workflows/profile_orig_cbds_lam_terminating_outer_big.yml)
    - [![Profile original cbds and lam terminating outer loop, small](https://github.com/0thopt/bds/actions/workflows/profile_orig_cbds_lam_terminating_outer_small.yml/badge.svg)](https://github.com/0thopt/bds/actions/workflows/profile_orig_cbds_lam_terminating_outer_small.yml)
    ...
    - [![Profile original cbds and lam1 terminating outer loop, big](https://github.com/0thopt/bds/actions/workflows/profile_orig_cbds_lam1_terminating_outer_big.yml/badge.svg)](https://github.com/0thopt/bds/actions/workflows/profile_orig_cbds_lam1_terminating_outer_big.yml)
    - [![Profile original cbds and lam1 terminating outer loop, small](https://github.com/0thopt/bds/actions/workflows/profile_orig_cbds_lam1_terminating_outer_small.yml/badge.svg)](https://github.com/0thopt/bds/actions/workflows/profile_orig_cbds_lam1_terminating_outer_small.yml)
