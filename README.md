...
- [Tests](https://github.com/zeroth-order-optimization/bds/actions) at [zeroth-order-optimization/bds](https://github.com/zeroth-order-optimization/bds)
    ...
    - [![Profile cbds with window_size 14 and func_tol 12x, big](https://github.com/zeroth-order-optimization/bds/actions/workflows/profile_cbds_window_size_14_func_tol_12_big.yml/badge.svg)](https://github.com/zeroth-order-optimization/bds/actions/workflows/profile_cbds_window_size_14_func_tol_12_big.yml)
    - [![Profile cbds with window_size 14 and func_tol 14x, big](https://github.com/zeroth-order-optimization/bds/actions/workflows/profile_cbds_window_size_14_func_tol_14_big.yml/badge.svg)](https://github.com/zeroth-order-optimization/bds/actions/workflows/profile_cbds_window_size_14_func_tol_14_big.yml)
    - [![Profile cbds with window_size 14 and func_tol 16x, big](https://github.com/zeroth-order-optimization/bds/actions/workflows/profile_cbds_window_size_10_func_tol_16_big.yml/badge.svg)](https://github.com/zeroth-order-optimization/bds/actions/workflows/profile_cbds_window_size_14_func_tol_16_big.yml)
