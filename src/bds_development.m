...
scheme = "cyclic"; % Default scheme is cyclic.
...
with_cycling_memory = true; % Default value of with_cycling_memory is true.
...
if use_estimated_gradient_stop
    ...
    if isfield(options, "finite_difference_mode")
        ...
        grad_info.finite_difference_mode = "central_difference_mode";
    end
...
% is achieved or not.
output_sufficient_decrease = true;
...
for iter = 1:maxit
    ...
    if use_estimated_gradient_stop
        grad_info.fopt = fopt;
        [grad, is_grad_returned, directional_derivative]  = estimate_gradient_old(grad_info);
