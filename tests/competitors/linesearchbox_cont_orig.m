function [alfa, fz, nf, i_corr_fall, output] = linesearchbox_cont_orig(fun, MaxFunctionEvaluations, Algorithm, ...
            ...
            while true
                ...
                if fzdelta < fpar
                    ...
                    if strcmpi(Algorithm, 'LAM1') || strcmpi(Algorithm, 'LAM2')
                        ...
                        % which is alfa or alfaex * delta1. Since Giampaolo declare that the original code has better
                        % performance, we will use alfaex * delta1 in linesearchbox_cont_orig.m.
                        alfa_d(j) = delta * alfa;
                    end
                    if iprint >= 1
