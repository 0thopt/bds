function [xval, fval, exitflag, output] = fmds(fun, x0, options)
%FMDS solves unconstrained optimization problems without using derivatives. 
%
...
% Set the reduction factor. We adopt the reduction factor in the paper Numerical solution of a minimum
% problem, 1952. As long as the algorithm can have simple decrease, the linesearch will be executed again.
reduction_factor = 0;
...
% Set the value of expand factor. Since the expand factor in the paper Numerical solution of a minimum
% problem, 1952 is set to 1.5, we set the default value of expand to 1.5.
expand = 1.5;

% Set the value of shrink factor. We adopt the shrink factor in the paper Numerical solution of a minimum
% problem, 1952.
shrink = 0.5;
